...
function ParserTestSuite(callback){
	var inps = [
		...
		['', '1 Empty program'],
		['// feed', '2 Empty program'],
		['//feed\n', '3 Empty program'],
		['\n// feed', '4 Empty program'],
		['\n// feed\n', '5 Empty program'],
		['/* */', '6 Empty program'],
		['/*\ns,fd\n*/', '7 Empty program'],
		['/*\ns,fd\n*/\n', '8 Empty program'],
		...
		['\n\t// Used for trimming whitespace\n\ttrimLeft = /^\\s+/;\n\ttrimRight = /\\s+$/;\t\n','turned out this didnt crash (the feed below did), but whatever.'],
		...
		['(/\'/g, \'\\\\\\\'\') + "\'";', 'the sequence of escaped characters confused the tokenizer'],
                ['if (true) /=a/.feed("a");', 'regexp starting with "=" in not obvious context (not implied by preceding token)']
	];
