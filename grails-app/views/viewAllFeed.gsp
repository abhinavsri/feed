...
<div class="container">
    ...
    <div class="col-md-9 col-lg-9 col-sx-9 col-sm-9 ">
        <div class="row">
            <g:each in="${postList}" var="post">
                <div class="panel panel-viewFeed" >
                    ...
                    <div class="panel-body "  style="background-color: white;" id="collapseBody">
                        <div class="row">
        ...
        <div class="pagination">
            <g:paginate total="${postCount ?: 0}" controller="feed" max="10" action="allList" prev="previous" next="next"
                        />
        </div>
    </div>
